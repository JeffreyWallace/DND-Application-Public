...
public class DNDMonsterCreatorSimple extends Application
{
   Stage pStage;
   ...
   public DNDMonsterCreatorSimple()
   {}
   
   public DNDMonsterCreatorSimple(String urlIn,String userIn,String passwordIn)
   {
   url=urlIn;
   user=userIn;
   password=passwordIn;
   ...
   public void start(Stage primaryStage) 
   {
      ...
      TFL=new ArrayList<TextField>();
       ...
       String[] labels = {"Name", "Size", "Creature Type", "Sourcebook", "Hitpoints",  "CR", "XP","Armor Class"};
   ...
   private int addToSQL(String[] stringArray)
   {
         ...
         Hitpoints=stringArray[i];i++;
         ChallengeRating=stringArray[i];i++;
         Experience=stringArray[i];i++;
         ArmorClass=stringArray[i];i++;
         Strength=stringArray[i];i++;
         Dexterity=stringArray[i];i++;
         Constitution=stringArray[i];i++;
         Intelligence=stringArray[i];i++;
         Wisdom=stringArray[i];i++;
         Charisma=stringArray[i];i++;
   ...
   private class CreateMonster implements EventHandler<ActionEvent> 
   {
      ...
      public void handle(ActionEvent event) 
      {
         ...
         else
         {
            if(i==5)
            {
               if(ParseTextDouble(TFL.get(i).getText())!=-1)
               {
               //System.out.println("This line is "+ParseText(TFL.get(i).getText()));
               stats[i]=ParseText(TFL.get(i).getText());
               }
            }
            else if(ParseTextInt(TFL.get(i).getText())!=-1)
            {
            //System.out.println("This line is "+ParseText(TFL.get(i).getText()));
            stats[i]=ParseText(TFL.get(i).getText());
            }
            ...
            {
            allFieldsSuccessful++;
            //System.out.println("This line Failed "+ParseText(TFL.get(i).getText()));
            }
         }
